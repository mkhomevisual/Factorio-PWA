...
function ReportView() {
  const { labels, locale } = useContext(labelsContext); const [hours, setHours] = useState(8); const [report, setReport] = useState<ShiftReport | null>(null); const [error, setError] = useState(''); const [copied, setCopied] = useState(false);
  const liveRevision = useContext(liveContext);
